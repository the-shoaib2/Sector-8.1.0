...
const auth_page_1 = require("./web/auth-page");
...
function activate(context) {
    ...
    // Register Auth page
    const authPage = new auth_page_1.AuthPage(context.extensionUri, synapseClient);
    // Register commands
    context.subscriptions.push(vscode.commands.registerCommand('synapse.login', () => {
        authPage.showAuth();
    }));
    context.subscriptions.push(vscode.commands.registerCommand('synapse.auth', () => {
        authPage.showAuth();
    }));
