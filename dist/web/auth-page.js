...
class AuthPage {
    ...
    showAuth() {
        ...
        this._panel = vscode.window.createWebviewPanel(this._viewType, 'Synapse Authentication', vscode.ViewColumn.One, {
            enableScripts: true,
            localResourceRoots: [
    ...
    _getHtmlForWebview(webview) {
        const iconUri = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, 'resources', 'icon.svg'));
        return `<!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
