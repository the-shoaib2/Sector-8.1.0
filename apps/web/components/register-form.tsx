...
import { Code2, Loader2, Mail, Lock, Eye, EyeOff, User } from "lucide-react"
    ...
    <div className="flex min-h-screen flex-col items-center justify-center px-4 py-8">
      ...
      <Card className="w-full max-w-[400px]">
        <CardHeader className="space-y-2">
          <CardTitle className="text-xl font-bold text-center">Create your Synapse account</CardTitle>
          <CardDescription className="text-center text-xs">
            Join the learning platform and start your journey
          </CardDescription>
        </CardHeader>
